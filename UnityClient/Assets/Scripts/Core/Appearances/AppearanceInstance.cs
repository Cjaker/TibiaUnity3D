...
namespace OpenTibiaUnity.Core.Appearances
{
    ...
    public abstract class AppearanceInstance
    {
        ...
        public uint _id;
        public int _lastCachedSpriteIndex = -1;
        public int _lastInternalPhase = -1;
        public int _activeFrameGroupIndex = 0;
        public int _lastPatternX = -1;
        public int _lastPatternY = -1;
        public int _lastPatternZ = -1;

        private Vector2 _screenPosition = Vector2.zero;
        protected Matrix4x4 _trsMatrix = Matrix4x4.identity;
        public bool _shouldRecalculateTRS = true;
        ...
        public CachedSprite GetSprite(int layer, int patternX, int patternY, int patternZ, bool _)
        {
            ...
            else if (cachedRequest.Status == SpriteLoadingStatus.Loading)
